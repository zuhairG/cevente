...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { event_id: @rsvp.event_id, rsvp_num: @rsvp.rsvp_num, status: @rsvp.status, user_id: @rsvp.user_id }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { event_id: @rsvp.event_id, rsvp_num: @rsvp.rsvp_num, status: @rsvp.status, user_id: @rsvp.user_id }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
